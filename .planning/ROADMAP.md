...
(Frame revised 2026-04-30 — see `.planning/PROJECT.md` and `locally-twisted-decisions.md`. The destination is a fresh ERPNext v15 install; the migration sources are LT's business intent + catalog data from the catalog_data attempt and the legacy `locallytwisted.com` site.)
