...
- 2026-04-26: Project reframed from "catalog_data → ERPNext migration" to "First professional business platform for LT, built on ERPNext"
...
None active. All Phase 1 decision gates resolved. Photos for the small shop catalog already exist (`_resources/catalog_data-export/catalog.json` + 48 product images).
