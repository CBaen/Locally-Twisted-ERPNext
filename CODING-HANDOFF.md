...
Verification: `python scripts/verify/nav_ia.py`, focused
`npx.cmd playwright test scripts/verify/interactive_layout.spec.js --grep
"header breakpoint contract" --reporter=line`, and direct browser probes
passed for desktop/mobile navy strips.
