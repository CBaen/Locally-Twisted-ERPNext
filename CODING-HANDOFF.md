...
Next safe paperwork slice: turn the unpaid invoice review report into a reviewed Desk queue or draft-rendering workflow only after the desired Jeff/accounting review UX is clear. Do not send reminders, create live bank sync, auto-submit accounting records, or wire CRM stages to finance while doing that.
