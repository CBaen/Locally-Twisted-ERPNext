...
Next safe paperwork slice: turn the rendered unpaid invoice draft packets into a reviewed Desk queue or scheduled internal review digest only after the desired Jeff/accounting review UX is clear. Do not send reminders, create live bank sync, auto-submit accounting records, or wire CRM stages to finance while doing that.
