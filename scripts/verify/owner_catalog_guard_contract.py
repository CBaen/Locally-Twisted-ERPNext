#!/usr/bin/env python3
"""Verify LT owner users cannot directly mutate protected catalog records.
...
SITE = "frontend"
METHOD = "locally_twisted.verify.owner_catalog_guard_contract.run"
...
def main() -> int:
    ...
    try:
        ...
        print("[OWNER CATALOG GUARD CONTRACT] FAIL")
        print(f"  - {exc}")
        return 1
    ...
    print("[OWNER CATALOG GUARD CONTRACT] " + ("PASS" if not failures else "FAIL"))
