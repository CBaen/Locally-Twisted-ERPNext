"""Verify catalog color swatches are localized and wired into product drawers."""
...
CATALOG_PATH = REPO_ROOT / "_resources" / "catalog-source" / "catalog.json"
MAP_PATH = LOCAL_APP / "catalog_contract" / "color_swatch_map.json"
ASSET_PREFIX = "/assets/locally_twisted/images/color-swatches/catalog/"
