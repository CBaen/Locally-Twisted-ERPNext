...
Evidence: the current Kubuntu wrapper is `scripts/verify/run_playwright`;
older prior-host helper references are obsolete. Search contract, checkout
experience, ecommerce browser proof, and focused interactive layout passed.
