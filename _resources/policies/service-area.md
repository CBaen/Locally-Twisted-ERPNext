...
Confirmed by catalog_data policy reference and Guiding Light on 2026-05-05; delivery/legal details clarified by Guiding Light business proxy on 2026-05-06.
...
- **Out-of-area delivery:** available for quote before payment. The checkout should not send these customers to Stripe; the customer should be sent to `/contact` with checkout details and cart items carried forward.
- **Pickup/delivery windows:** requested until Locally Twisted confirms them.
- **No access/no contact:** if Locally Twisted cannot complete pickup, delivery, or setup because the on-site contact cannot be reached or access information is wrong, the customer remains responsible for the order and delivery charges.
- **Damage reports:** delivered product damage must be reported the same day.
- **Returns:** ready-to-order balloon products are not returnable once prepared, delivered, or picked up.

## Event and service quotes

Face painting, balloon twisting, corporate, school, civic, venue, and larger custom event work should start through `/contact`, not the cart. Delivery, setup, venue access, travel, timing, deposit, balance terms, and event-specific fees are handled on the quote.
...
- **Terms/FAQ/service pages:** repeat the same pickup/$15/$50/out-of-area quote model and the requested-until-confirmed timing rule.
