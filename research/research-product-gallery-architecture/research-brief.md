...
catalog_data reference: desktop thumbnails at the left of the main photo, thumbnail
...
- Source catalog_data catalog/image witness under `_resources/catalog-source/`.
...
- Holding all catalog_data additional images forever under the old "unclassified
  extra" rule.
...
- Dedupe paired catalog_data thumbnail/full-size URLs by semantic source key so a
