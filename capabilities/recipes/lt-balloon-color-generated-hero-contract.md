...
- If GL rejects a generated/AI-looking seasonal homepage hero as cartoony, use
  the homepage/compact-hero contracts and
  `lt-photoreal-balloon-homepage-hero-contract.md` instead of forcing this
  category-hero recipe. If a real-photo exception is approved, retain sources
  in `_resources/` with EXIF/GPS/device metadata stripped.
