...
2. Split work by user-facing lane, not technical layer.
   ...
   - Trust/policy: `/privacy`, `/terms-of-service`, `/refund-policy`, `/accessibility`, Stripe URL readiness. Business/legal content should trace to `C:\Users\baenb\projects\locally-twisted-odoo\`, approved current resources, or GL/legal approval.
   - Shop/media: product/category media, variant correctness, Item Group images, product detail confidence. Product/service claims should trace to the Odoo business-detail source or GL approval.
