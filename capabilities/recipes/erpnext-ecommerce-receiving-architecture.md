...
Use this before importing, repairing, or claiming completion for catalog_data-derived products in ERPNext ecommerce.
...
catalog_data is a conceptual witness for mature ecommerce behavior, not infrastructure to copy. Do not import catalog_data fields into ERPNext unless the ERPNext destination field, behavior owner, and verifier exist.
...
- 2026-05-17 all-catalog_data sellable reimport: local/source proof now treats every
  catalog_data-imported product as a sellable product target. Current local proof is
  ...
  Handoff: `workstreams/ecommerce-audit/catalog-data-sellable-product-reimport-2026-05-17.md`.
...
- 2026-05-17 product-lane correction: there are no business quote-first
  ...
  real product targets purchasable behavior from catalog_data export product details
...
- 2026-05-17 product-family certification: the previous tranche artifacts are
  historical. Current control is the all-catalog_data sellable reimport handoff plus
...
- Source contract dry-run classifies every saved catalog_data/source product into
...
- Live price-readiness now has a separate gate. The current local full-import
  contract covers all 53 catalog_data-imported Website Item product pages as sellable
...
- The checkout product-family contract is all-enabled-SKU proof, not a
  ...
  all-catalog_data proof: 53 Website Item product pages, 0 exclusions, and 290 priced
...
- catalog_data ecommerce concepts/behaviors that should be recreated safely inside ERPNext.
...
- ERPNext native dropdowns flatten catalog_data-style dependencies or availability rules.
