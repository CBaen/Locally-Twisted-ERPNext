...
- [shared-inquiry-form-experience](recipes/shared-inquiry-form-experience.md) - gate-backed LT public inquiry form contract: backend-proven success only, accessible on-page modal, safe failure copy, anti-bot token/honeypot, conservative sales-solicitation suppression, upload/email proof, tiered local-vs-live release evidence, and no overlaying cookie notice.
...
- [fail-loud-operating-law](recipes/fail-loud-operating-law.md) - architecture-backed LT operating law that makes forms, automations, documents, containers, checkout handoffs, and agent claims block false success with actionable failures and verifier evidence.
...
- [frappe-portfolio-proof-reel](recipes/frappe-portfolio-proof-reel.md) - verifier-backed local contract for keeping LT's portfolio as a compact native-shell proof collage with large whole photos, center balance, and no wholesale prototype styling.
