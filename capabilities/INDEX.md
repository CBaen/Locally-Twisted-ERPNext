...
- [customer-client-portal-contract](recipes/customer-client-portal-contract.md) - keep invite-only customer/client account routes, safe summaries, portal actions, file registration, organization access, and branded account shell aligned.
