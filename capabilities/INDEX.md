...
- [lt-photoreal-balloon-homepage-hero-contract](recipes/lt-photoreal-balloon-homepage-hero-contract.md) - generate, store, review, and crop homepage hero image option sets only when the balloon decor reads as photoreal, physically plausible installed work and GL approves the final selection.
...
- [public-form-raw-payload-log-pii-drift](failures/public-form-raw-payload-log-pii-drift.md) - prevents public inquiry failure paths from logging raw customer form submissions into Frappe Error Log before paid traffic.
...
- [product-primary-media-attachment-drift](failures/product-primary-media-attachment-drift.md) - prevents gallery/photo deletion from being mistaken for Website Item, Item, Product Blueprint, File attachment, product-page, and homepage primary-image repair.
- [product-setup-projection-authority-drift](failures/product-setup-projection-authority-drift.md) - prevents owner-visible Product Setup save success from being mistaken for public/runtime price, copy, media, option, add-on, cart, or checkout authority.
