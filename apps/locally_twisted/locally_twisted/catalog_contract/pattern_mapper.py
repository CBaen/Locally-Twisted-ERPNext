"""Reusable catalog_data option-pattern mapper for product imports.
...
SCHEMA_VERSION = "lt-catalog_data-option-pattern-contract-v1"
...
class ProductPatternReport:
    ...
    def to_artifact(self) -> dict[str, Any]:
        return {
            ...
            "purpose": "Reusable catalog_data option-pattern classification feeding ERPNext ProductPatternContract imports.",
    ...
    def to_markdown(self) -> str:
        ...
        lines = [
            ...
            "## Pattern Matrix",
            "",
            "| catalog_data pattern | ERPNext primitive / contract | Missing generic architecture | Import implications |",
            "|---|---|---|---|",
        ]
...
def build_product_pattern_contract(product: dict[str, Any]) -> ProductPatternContract:
    ...
    return ProductPatternContract(
        ...
        catalog_data_product_id=_clean(product.get("catalog_data_id")),
