...
AxisSource = Literal["catalog_data_source", "erpnext_variant", "combined"]
...
class AxisContract:
    ...
    source: AxisSource = "catalog_data_source"
...
def _apply_mapper_enforcement(
    ...
    if not source_integrity or not import_requirements:
        ...
        required_work.append("Carry catalog_data mapper source integrity and import requirements into the ProductPatternContract.")
...
def _warnings(
    ...
    if source_product and not source_pattern:
        warnings.append("Source product could not be classified by catalog_data option-pattern mapper.")
