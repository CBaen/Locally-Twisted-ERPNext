...
SWATCH_MAP_FILE = Path(__file__).with_name("color_swatch_map.json")
...
QUALATEX_GUIDE_APPROX_HEX = {
    ...
    "smoke grey": "#8d9290",
    "smoke gray": "#8d9290",
    "reflex silver": "#c7c9c7",
    "reflex gold": "#c8a64b",
    "reflex green": "#227a57",
    "reflex violet": "#60439a",
    "reflex red": "#b51f2f",
    "sangria": "#934058",
    "samba": "#8f3f5f",
    "cranberry": "#ac4d4d",
...
def swatch_url_for_color(name: str, axis_name: str | None = None, item_code: str | None = None) -> str:
    """Return the localized owner-approved color swatch image for a color, if mapped."""
    data = _swatch_map()
    if not data:
        return ""
...
def _classified_color(clean: str, group: str, axis_name: str | None, item_code: str | None) -> ClassifiedColor:
    ...
    return ClassifiedColor(
        ...
        status="owner_color_swatch" if swatch_url else "approximate_review",
    )
