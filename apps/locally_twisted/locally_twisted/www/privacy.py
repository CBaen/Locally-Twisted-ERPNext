...
def get_context(context):
    context.title = "Privacy Policy | Locally Twisted"
    context.metatags = {
        "description": (
            "How Locally Twisted collects and uses information for inquiries, "
            "event bookings, orders, payments, and newsletter signups."
        ),
        "og:title": "Privacy Policy | Locally Twisted",
        "og:description": (
            "Plain-language privacy information for Locally Twisted customers."
        ),
        "og:type": "website",
    }
