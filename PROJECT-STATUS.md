...
> **Public ecommerce testing correction, 2026-05-17; taxonomy refreshed 2026-05-24:** Local ecommerce may be temporarily opened for proof runs, but the safe resting state is `lt_ecommerce_paused=1`. Current category/count proof is 51 published products, 8 active primary categories, and 9 hidden secondary occasion categories. This does not approve staging/live cutover; GL local testing, staging proof, live payment readiness, and DNS/Frappe Cloud gates still stand.
...
- **Current taxonomy proof rechecked 2026-05-24: 51 Website Items, 8 visible primary Item Groups under `Shop Items`, 9 secondary groups under hidden `Shop Occasions`, 51 secondary Website Item Group rows, 30 checkout Website Items, and 21 quote-first Website Items.** Older 53-product and 11-category claims are historical baseline language, not the active customer-facing contract.
