...
**Reconciliation note (2026-05-05):** `scripts/verify/layout_fit.spec.js` is restored and currently verifies through `npm run test:layout-fit` (80 passed). Treat `.planning/phases/01-customer-site-and-storefront/PLAN.md` as historical; `/contact` is the primary inquiry route and `/book` redirects to `/contact?intent=quick`.
