...
- [P1] **Decide on Jeff Kimber placeholder user** (`locallytwisted@yahoo.com`, full_name "Jeff Kimber", System Manager) — created by an earlier wizard run with placeholder data. Real Jeff is `Jeff Baen / locallytwisted@gmail.com` (now also exists as a System Manager). GL to choose: delete, rename, or leave.
