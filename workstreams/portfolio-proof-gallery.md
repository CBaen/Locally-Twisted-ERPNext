...
- `scripts/verify/portfolio_reel.spec.js` verifies desktop reel behavior, optimized image usage, mobile full-width stacking, image aspect handling, query filtering, and empty-state layout.
...
Latest focused local verification on 2026-05-06: `/portfolio` returned 200; portfolio CSS, JS, and optimized images returned 200; portfolio reel 3/3 passed; layout-fit grep portfolio 13/13 passed; interactive-layout grep portfolio 3/3 passed.
