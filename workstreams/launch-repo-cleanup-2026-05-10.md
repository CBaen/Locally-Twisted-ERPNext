...
- Removed old ignored Odoo mirror/reference output, old Chrome/audit render output, upstream app clones, and research throwaways that were no longer source of truth.
