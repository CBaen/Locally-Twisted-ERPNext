...
Launch-blocking cleanup for Locally Twisted customer/client-facing surfaces. Goal: Jeff, customers, accounts payable contacts, event buyers, procurement contacts, and public visitors do not see ERPNext/Frappe/catalog_data/platform branding or framework-language leakage in outward surfaces.
...
- Expanded Playwright public white-label word gate to include catalog_data.
