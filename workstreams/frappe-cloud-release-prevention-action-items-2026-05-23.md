...
`9e63fef7d786ea24dc1ffa8dbf9e6cffa03847d7`. It confirms the app-root
...
2026-05-23 release JSON BOM guard:
`workstreams/frappe-cloud-release-json-artifact-bom-guard-2026-05-23.md`.
The controller now reads JSON artifacts with `utf-8-sig` so a PowerShell
UTF-8 BOM does not block before the intended release gate. This is local
guard hardening only, not approval or mutation.
...
This packet updates no-go evidence at source
`b0396675a8664a42e887b6ac141b63ac115eaaa7`. It is not mutation proof for a
later commit.
...
2026-05-23 oldest archived snapshot-source read-only packet:
