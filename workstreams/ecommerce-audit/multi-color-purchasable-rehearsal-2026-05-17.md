...
- Proved Odoo source rows exist for all six products.
...
The first run failed because Odoo's export contains duplicate color labels that
...
canonical names used by the Odoo value-normalize map:
