...
This tranche table is historical as of the later 2026-05-17 all-catalog_data sellable
...
Current verified state: 53 catalog_data-imported products included, 0 excluded, 290
...
`catalog-data-sellable-product-reimport-2026-05-17.md`.
...
purchasable. Pricing and product details should come from the catalog_data product
...
| Product source repair map | PASS | `python scripts/verify/product_source_repair_map.py`; 53/53 catalog_data export rows found, 18 certified checkout products, 35 blocked-until-certified products, 0 contract failures |
...
3. Use `product-source-repair-map-2026-05-17.md` to repair the remaining
   product-family holds into purchasable products; repull the catalog_data export if
