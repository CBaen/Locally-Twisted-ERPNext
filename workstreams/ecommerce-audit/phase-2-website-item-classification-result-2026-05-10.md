...
Non-scope: no Odoo mutation, no product publish/unpublish/hide/delete/purge/reimport, no price/media/business-copy changes, no public ecommerce opening, no payment/customer messaging action.
