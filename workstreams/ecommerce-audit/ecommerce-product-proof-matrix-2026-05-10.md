D:2026-05-10 | Check:local catalog_data-source audit JSON + media packet + price packet 2026-05-10 | Confidence:[LOCAL-PROOF]

# Ecommerce Product Proof Matrix — catalog_data → ERPNext
...
| # | Product | catalog_data ID | Lane | Required axes | Customization axes | Add-ons | Price status | Units | Media | Purge/import status | Immediate action |
|---:|---|---:|---|---|---|---|---|---:|---|---|---|
