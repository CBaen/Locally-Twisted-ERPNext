...
- catalog_data is read-only source witness only.
- Do not save/create/delete/send/post/pay/import/publish in catalog_data.
...
Direct checkout is **not** for all catalog_data product complexity.
...
4. `workstreams/ecommerce-audit/catalog_data-backend-architecture-and-checkout-logic-2026-05-10.md`
5. `workstreams/ecommerce-audit/ecommerce-infrastructure-readiness-packet-2026-05-10.md`
6. `workstreams/ecommerce-audit/erpnext-receiving-build-spec-from-catalog_data-2026-05-10.md`
...
## catalog_data witness summary

catalog_data taught us the pattern:
...
- 128 saleable catalog_data templates checked,
...
- copying catalog_data code/schema.
