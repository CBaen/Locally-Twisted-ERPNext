...
| Large head Missionary | `large-head-missionary` | blocked_until_certified | simple_purchasable_rehearsal | found | 30 | Payment Request/Payment Entry cascade proof<br>receipt/operator/welcome email proof<br>final owner/product-scope approval before customer exposure |
...
| Mother's day front yard 7' Column | `mothers-day-front-yard-7-column` | blocked_until_certified | simple_purchasable_rehearsal | found | 1 | Payment Request/Payment Entry cascade proof<br>receipt/operator/welcome email proof<br>final owner/product-scope approval before customer exposure |
...
| Easter Arch | `easter-arch` | blocked_until_certified | simple_purchasable_rehearsal | found | 1 | Payment Request/Payment Entry cascade proof<br>receipt/operator/welcome email proof<br>final owner/product-scope approval before customer exposure |
...
| Pride Arch | `pride-arch` | blocked_until_certified | simple_purchasable_rehearsal | found | 1 | Payment Request/Payment Entry cascade proof<br>receipt/operator/welcome email proof<br>final owner/product-scope approval before customer exposure |
