D:2026-05-10 | Check:GL scope correction 2026-05-10 14:48 MDT + live Odoo architecture witness | Confidence:high
# Ready-to-order checkout scope decision

## Decision

Locally Twisted should **not** try to launch all Odoo-style configurable products as direct checkout products in ERPNext right now.
...
> recreate every Odoo product option path as direct checkout.
...
## What we still need from Odoo

For **ready-to-order checkout products**, we still need a narrow Odoo witness slice:
...
For **complex decor / major variant products**, we do not need exhaustive direct-checkout parity right now. We only need enough Odoo evidence to route them safely:
...
Create a ready-to-order product candidate list from Odoo/ERPNext and classify each candidate as:
