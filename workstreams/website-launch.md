...
| Paperwork/backend automation | Invoices, payment requests, receipt emails, operator notifications, unpaid/overdue review, automation index, scheduled checkups, live-mode blockers | Coordinate through `workstreams/paperwork-backend-automation.md` and `workstreams/business-automation-index.md`; no auto-submit or reminder sending without approval | Turns back-office launch risk into reviewable queues |
